...
function getNormalizeWithNFKC() {
	...
	// PDF.js validates this table in TESTING builds against the current JS
	// engine's Unicode data. Reader uses the baked table directly so a runtime
	// mismatch cannot break all PDF search.
