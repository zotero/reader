...
import { createSDTBlockCropProvider } from './lib/sdt-block-crops';
...
class PDFView {
	...
	createSDTBlockCropProvider(sdtData) {
		return createSDTBlockCropProvider(
			sdtData,
			(pageIndex, rects) => this._pdfRenderer.renderRegionCrops(pageIndex, rects)
		);
	}
