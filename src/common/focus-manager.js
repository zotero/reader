...
export class FocusManager {
	...
	_handlePointerDown(event) {
		if ('closest' in event.target) {
			...
			if (!event.target.closest('input, textarea, select, [contenteditable="true"], .annotation, .thumbnails-view, .outline-view, .listbox, .error-bar, .reference-row, .preview-popup, .appearance-popup, #selector')) {
